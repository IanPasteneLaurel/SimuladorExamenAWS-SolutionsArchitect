...
const mb7 = JSON.parse(fs.readFileSync('mass-processing/mega-batch-7-of-9.json', 'utf8'));

console.log('Procesando MB-7:', mb7.length, 'preguntas');

const enriched = mb7.map(q => {
  const why_wrong = {};
...
fs.writeFileSync('enriched-mb7.json', JSON.stringify(enriched, null, 2));
console.log('✅ Guardado enriched-mb7.json:', enriched.length, 'preguntas');
