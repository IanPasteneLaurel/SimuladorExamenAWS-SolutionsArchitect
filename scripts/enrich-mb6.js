...
const mb6 = JSON.parse(fs.readFileSync('mass-processing/mega-batch-6-of-9.json', 'utf8'));

console.log('Procesando MB-6:', mb6.length, 'preguntas');

const enriched = mb6.map(q => {
  const why_wrong = {};
...
fs.writeFileSync('enriched-mb6.json', JSON.stringify(enriched, null, 2));
console.log('✅ Guardado enriched-mb6.json:', enriched.length, 'preguntas');
